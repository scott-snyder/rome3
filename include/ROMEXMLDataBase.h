/********************************************************************
  ...
  $Id: ROMEXMLDataBase.h 2033 2007-08-05 22:58:11Z sawada $
...
protected:
   ...
   Bool_t WriteValue(ROMEPath *path,ROMEString& basePath,ROMEString& value,Int_t arrayIndex) const;
   Int_t  SearchTable(ROMEPath *path,ROMEStr2DArray *values,const char* dataBasePath,
...
public:
   ...
   const char *GetType() const { return "xml"; }
   const char *GetDescription() const { return "XML data base reflecting the structure of an SQL data base"; }
